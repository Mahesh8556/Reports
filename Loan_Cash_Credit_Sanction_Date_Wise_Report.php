...
$filename = __DIR__.'/Loanccacsanctiondatewise2.jrxml';
...
$date ="'02/08/2021'";
$sql =pg_query($conn,'SELECT LNMASTER."AC_ACNOTYPE",LNMASTER."AC_TYPE",LNMASTER."AC_NO",LNMASTER."AC_NAME",
...
AND cast(LNMASTER."AC_SANCTION_DATE" as date)>= '.$date.' :: date
AND cast(LNMASTER."AC_SANCTION_DATE" as date) <= '.$date.' :: date  
...
while($row = pg_fetch_assoc($sql)){
    ...
    $tmp=[
        ...
        'field3' => $GRAND_TOTAL,
        'field4' => $TOTAL,
        'field5' => $subAC_SECURITY_AMT,
        'field6' => $subAC_SANCTION_AMOUNT
