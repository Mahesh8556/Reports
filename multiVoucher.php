...
// $filename1 = __DIR__.'/multiVoucher1.jrxml';
// $filename = __DIR__.'/multiVoucher.jrxml';
$filename1 = __DIR__.'/multiVoucher1Vadgaon.jrxml';

$filename = __DIR__.'/multiVoucherVadgaon.jrxml';
$data = [];
...
$type == 4? $checktype='true': $checktype='false';
// echo $checktype;
...
AND "TRAN_NO"='.$tranno.' AND 	VWTMPTRANTABLE."TRAN_DRCR" ='.$debit.'';
}
else if($flag == 1)
{
$query='SELECT CASE "TRAN_TYPE" WHEN '.$CS.' THEN '.$CashVALUE.' ELSE '.$transferVALUE.' END "MAR_TRANTYPE",
...
AND CAST(VWTMPTRANTABLE."TRAN_AMOUNT" AS FLOAT) <> 0
AND ("TRAN_SOURCE_TYPE" <> '.$d .'	OR "TRAN_SOURCE_TYPE" IS NULL)
AND "TRAN_NO"='.$tranno.' AND 	VWTMPTRANTABLE."TRAN_DRCR" ='.$credit.'';
}
else
{
...
else if($type == 5)
{
    if($flag == 0)
    {
        $query = 'SELECT CASE "TRAN_TYPE"
        WHEN '.$CS.' THEN '.$CashVALUE.'
        ELSE '.$transferVALUE.'
END "MAR_TRANTYPE",
SCHEMAST."S_NAME",
VWTMPTRANTABLE."TRAN_NO" AS "TRAN_NO",
...
VWTMPTRANTABLE."TRAN_AMOUNT",
VWTMPTRANTABLE."TRAN_GLACNO",
REPLACE(REPLACE(VWTMPTRANTABLE."NARRATION",

    CHR(10),
    '.$singlequote.'),

CHR(13), '.$singlequote.') NARRATION,
VWALLMASTER."ac_name" AS "AC_NAME",
CAST(LEDGERBALANCE(CAST("TRAN_ACTYPE" AS CHARACTER VARYING),
...
FN_AMTTOWORDENGLISH(CAST(LEDGERBALANCE(CAST("TRAN_ACTYPE" AS CHARACTER VARYING),
                                                                        ...
                                                                        1) AS FLOAT) + CASE "TRAN_DRCR"
                                                                                                                                                    ...
                                                                                                                                                    ELSE (-1) * CAST("TRAN_AMOUNT" AS FLOAT)
                                                                                                                                    END) "INWORDS",
CAST(TRIM(CASE "TRAN_SOURCE_TYPE"
                        WHEN '.$JV.' THEN CASE "TRAN_TYPE"
                                                                                                    WHEN '.$Amount.' THEN CASE "TRAN_ACNOTYPE"
                                                                                                                                                                                                WHEN '.$GL.' THEN '.$Gross.'
                                                                                                                                                                                                ELSE GETACNAME(CAST("TRAN_ACTYPE" AS CHARACTER VARYING),

                                                                                                                                                                                                                        "TRAN_ACNO") || CHR(13)
                                                                                                                                                                                END
                                                                                                    ELSE '.$Balance.'
                                                                                    END
                        ELSE CASE "TRAN_SOURCE_TYPE"
                                                            WHEN '.$Balance.' THEN GETACNAME(CAST("TRAN_ACTYPE" AS CHARACTER VARYING),

                                                                                                                                                "TRAN_ACNO")
                                                            ELSE '.$singlequote.'
                                            END || CHR(13)
        END || ACMASTER."AC_NAME" || '.$singlequote.' || '.$ACNO.' || "TRAN_ACNO") AS CHARACTER VARYING) "GLAC_NAME",
ACMASTER."AC_NAME" AS GL_NAME,
"TRAN_ACNOTYPE",
"TRAN_ACTYPE",
"TRAN_ACNO",
VWTMPTRANTABLE."TRAN_SOURCE_TYPE",
VWTMPTRANTABLE."TRAN_SOURCE_NO",
VWTMPTRANTABLE."TRAN_BRANCH_CODE",
GL_STATEMENT_CODE.ID AS "STATEMENT_CODE"
FROM ACMASTER,
...
CAST(DAILYTRAN."TRAN_BRANCH_CODE" AS INTEGER) AS "TRAN_BRANCH_CODE",
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$transfer.' THEN CAST("TRAN_AMOUNT" AS float)
                            ELSE 0
            END,
0) + COALESCE(CASE
                                                    WHEN "TRAN_TYPE" = '.$JV.' THEN CAST("TRAN_AMOUNT" AS FLOAT)
                                                    ELSE 0
                                    END,

    0) AS TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("TRAN_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) AS CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("TRAN_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) AS CLEARINGAMT,
'.$TRAN_AMOUNT.' REF_FIELD
FROM DAILYTRAN,
ACMASTER
WHERE DAILYTRAN."TRAN_GLACNO" = ACMASTER."AC_NO"
AND CAST(DAILYTRAN."TRAN_DATE" AS DATE) = TO_DATE('.$sdate.','.$dateformate.')
AND CAST(DAILYTRAN."TRAN_STATUS" AS CHARACTER VARYING) <> '.$TRAN_STATUS.'
AND DAILYTRAN."TRAN_BRANCH_CODE" = '.$code.'
UNION ALL SELECT "TRAN_NO",
"TRAN_DATE",
"TRAN_TIME",
"TRAN_TYPE",
...
"TRAN_PROCESS_YEAR",
"TRAN_PROCESS_MONTH",
CAST("TRAN_ACTYPE" AS INTEGER) AS "TRAN_GLACTYPE",
"TRAN_GLACNO",
ACMASTER."AC_SUBSCODE",
CAST("TRAN_ACTYPE" AS INTEGER),
"TRAN_ACNO",
...
AND CAST(HISTORYTRAN."TRAN_DATE" AS DATE) = TO_DATE('.$sdate.',
                                                                                                                                                            ...
                                                                                                                                                            '.$dateformate.')
AND CAST(HISTORYTRAN."TRAN_STATUS" AS CHARACTER VARYING) <> '.$TRAN_STATUS.'
AND HISTORYTRAN."TRAN_BRANCH_CODE" = '.$code.'
UNION ALL SELECT "TRAN_NO",
"TRAN_DATE",
"TRAN_TIME",
"TRAN_TYPE",
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("INTEREST_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("INTEREST_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$INTEREST_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("RECPAY_INT_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("RECPAY_INT_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$RECPAY_INT_AMOUNT.' REF_FILED
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("PENAL_INT_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("PENAL_INT_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$PENAL_INT_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("REC_PENAL_INT_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("REC_PENAL_INT_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$REC_PENAL_INT_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER1_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER1_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER1_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER2_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER2_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER2_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER3_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER3_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER3_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER4_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER4_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER4_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER5_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER5_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER5_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER6_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER6_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER6_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER7_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER7_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER7_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER8_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER8_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER8_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER9_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER9_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER9_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER10_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER10_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER10_AMOUNT.' REF_FIELD
...
0)TRANSFERAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$CS.' THEN CAST("OTHER11_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CASHAMT,
COALESCE(CASE
                            WHEN "TRAN_TYPE" = '.$C.' THEN CAST("OTHER11_AMOUNT" AS FLOAT)
                            ELSE 0
            END,
0) CLEARINGAMT,
'.$OTHER11_AMOUNT.' REF_FIELD
...
AND CAST(HISTORYTRAN."OTHER11_AMOUNT" AS FLOAT) > 0
AND CAST(HISTORYTRAN."TRAN_STATUS" AS CHARACTER VARYING) <> '.$TRAN_STATUS.'
AND HISTORYTRAN."TRAN_BRANCH_CODE" = '.$code.' ) VWTMPTRANTABLE
LEFT JOIN SCHEMAST ON SCHEMAST.ID = VWTMPTRANTABLE."TRAN_ACTYPE",
GL_STATEMENT_CODE,
VWALLMASTER
WHERE CAST(VWTMPTRANTABLE."TRAN_GLACNO" AS BIGINT) = CAST(ACMASTER."AC_NO" AS BIGINT)
AND GL_STATEMENT_CODE.ID = CAST(ACMASTER."AC_BCD" AS INTEGER)
AND VWTMPTRANTABLE."TRAN_ACNO" = VWALLMASTER."ac_no"
AND CAST(VWTMPTRANTABLE."TRAN_AMOUNT" AS FLOAT) <> 0
AND ("TRAN_SOURCE_TYPE" <> '.$debit.'
OR "TRAN_SOURCE_TYPE" = '.$voucher_type.')
AND "TRAN_NO" = '.$tranno.'
AND VWTMPTRANTABLE."TRAN_DRCR" = '.$debit.'';
    }
    else if($flag == 1)
    {
...
OR "TRAN_SOURCE_TYPE" = '.$voucher_type.')
AND "TRAN_NO" = '.$tranno.'
AND VWTMPTRANTABLE."TRAN_DRCR" = '.$credit.'';
...
while($row = pg_fetch_assoc($sql)){
    ...
    {
        $crdr="CR";
        $creditbal = $creditbal + $row['TRAN_AMOUNT'];
    }
    else{
        $crdr="DR";
        $debitbal = $debitbal + $row['TRAN_AMOUNT'];
    }
...
$balshow='';
  ...
  $balshow=  $bal['fn_amttowordenglish'];
    ...
    $tmp=[
       ...
       'creditbal' => sprintf("%.2f", ($creditbal + 0.0)),
       'debitbal' => sprintf("%.2f", ($debitbal + 0.0)),
       'amtInWords' => $balshow,
       'flag' => $flag,
       'type'=> $tran_type,
    ];  
