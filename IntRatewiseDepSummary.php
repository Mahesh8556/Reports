...
dpmaster."AC_INTRATE",sizewisebalance."AMOUNT_FROM",sizewisebalance."AMOUNT_TO",
...
INNER JOIN ownbranchmaster ON
 ...
 TERMMASTER."ACNOTYPE" = dpmaster."AC_ACNOTYPE" 
...
AND CAST(dpmaster."AC_INTRATE" AS FLOAT) >  SIZEWISEBALANCE."AMOUNT_FROM" AND  CAST(dpmaster."AC_INTRATE" AS FLOAT) <= SIZEWISEBALANCE."AMOUNT_TO"
 Group By dpmaster."AC_ACNOTYPE",DPMASTER."AC_TYPE", DPMASTER."AC_NO" ,DPMASTER."AC_INTRATE",SCHEMAST."S_APPL",OWNBRANCHMASTER."CODE",
 TERMMASTER."ACNOTYPE", DPMASTER."BANKACNO",DPMASTER."AC_OPDATE",sizewisebalance."AMOUNT_FROM",sizewisebalance."AMOUNT_TO",termmaster."TERM_TYPE",dpmaster."AC_MONTHS" ';
